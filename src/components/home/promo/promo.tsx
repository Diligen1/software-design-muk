    ...
    <main className="mx-auto" id="promo">
      <div className="w-full pt-[60px] h-[700px] flex justify-center items-center px-[20px]">
        <div className="w-[35%] h-full flex flex-col items-start justify-center gap-[40px] ">
          ...
          <Link
            href="/#lectures"
            className=" cursor-pointer w-[200px] h-[50px] text-[18px] flex justify-center items-center duration-300 rounded-[16px] border-[1px] border-[var(--second-color)] hover:border-[var(--text-color)] bg-[var(--text-color)] hover:bg-[var(--second-color)] text-white hover:text-[var(--text-color)]"
          >
            <p>ПЕРЕЙТИ</p>
          </Link>
        </div>
